...
@section('content')
{{-- ⚠️ Importante: NO mostrar aquí session('ok') para evitar duplicados.
     El layout principal ya lo hace. --}}
...
<div class="d-flex align-items-center justify-content-between mb-3">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
                <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('markSentForm').submit();">
                    Marcar como enviada
                </a>
            </li>
            @php
...
(function(){
    ...
    // Precargar el pendiente para que no olviden el blur
    ...
    function parseMoney(text){
        ...
        if (raw.includes('.') && raw.includes(',')) { // 1.234,56
            raw = raw.replace(/\./g,'').replace(',', '.');
        } else if (raw.includes(',') && !raw.includes('.')) { // 123,45
            raw = raw.replace(',', '.');
        } // else 1234.56
