...
@push('head')
<style>
    /* Evitar que el dropdown quede cortado por el contenedor */
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">
                    ...
                    {{-- Modal enviar email por fila (ligero) --}}
            ...
            @empty
            <tr>
                <td colspan="7" class="text-center text-muted py-4">Aún no hay facturas.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
...
<script>
    async function copyPublicLink(url, invoiceId) {
        try {
            ...
            // Si existe la ruta que registra y devuelve la URL (opcional)
            let finalUrl = url;
            try {
