        ...
        <div class="col-lg-8">
            ...
            <div class="card card-soft mb-3">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.password') }}" class="row g-3" novalidate>
                        @csrf
                        <div class="col-md-4">
            ...
            <div class="card card-soft">
                <div class="card-body">
                    ...
                    <p class="text-muted small">Esta acción es irreversible. Se cerrará tu sesión y tu cuenta será
                        eliminada.</p>
